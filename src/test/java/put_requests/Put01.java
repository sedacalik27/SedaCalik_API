...
public class Put01 extends JsonPlaceHolderBaseUrl {//güncelleme
     /*
        Given
    ...
    public void put01methodlu() {
        ...
        assertEquals(payLoad.get("title"),actualData.get("title"));
        assertEquals(payLoad.get("completed"),actualData.get("completed"));
        assertEquals(payLoad.get("id"),actualData.get("id"));//bu şekilde yapacaksak yukarıda  payLoad.put("id",198); bunu yapmalıyız.
        //assertEquals(198,actualData.get("id"));bu şeklidede yapabiliriz
